...
function buildUI(thisObj){
	...
	if(win != null){
		...
		folder_group: Group {orientation: 'row', et_folder: EditText{text: 'T:/_Pipeline/cobopipe_v02-001/AfterEffect/AE_Scripts', preferredSize: ['175','20']}, pick_folder_button: Button{text:'Pick Folder'} }\
