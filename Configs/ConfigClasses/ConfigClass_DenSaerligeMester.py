...
class ConfigClass():
    def __init__(self):
        self.project_name="DenSaerligeMester"
        self.base_path="P:/930440_Den_saerlige_mester/Pilot"
        ...
        self.shot_animatic_file="<shot_path>/<episode_name>_<seq_name>_<shot_name>_Animatic.mp4"
        ...
        self.users={'Animation': ['Tue'], 'Render': ['Christian', 'Simon', 'Kaare', 'Alexandra']}
        ...
        self.project_settings={'fps': '25fps', 'cmEnabled': True, 'cmViewTransform': 'sRGB gamma'}
        ...
        import getConfig
        self.old = None
        self.util = getConfig.getJsonConfigUtil("DenSaerligeMester")
    ...
    def get_ae_precomp_template_file(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/Template/_AECompTemplate/ae_precomp_template.aep"
        return to_return
    ...
    def get_asset_base_path(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_asset_design_folder(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/04_Design".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return


    def get_asset_publish_path(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/PublishReports/Assets"
        return to_return
    ...
    def get_asset_publish_report_file(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/PublishReports/Assets/{asset_type}/{asset_category}/{asset_name}.json".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_asset_ref_folder(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_asset_texture_folder(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/03_Texture".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return


    def get_asset_top_path(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets"
        return to_return
    ...
    def get_asset_work_file(self,asset_type=None,asset_category=None,asset_name=None,asset_step=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/01_Work/Maya/{asset_name}_{asset_step}.ma".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,asset_step=asset_step,)
        return to_return
    ...
    def get_asset_work_folder(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/01_Work/Maya".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return


    def get_base_path(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot"
        return to_return


    def get_contact_sheet_category_file(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/contact_sheet_category.json"
        return to_return


    def get_cryptomatte_list(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/cryptomatteList.json"
        return to_return
    ...
    def get_episode_info_file(self,episode_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_BrowserInfo.json".format(episode_name=episode_name,)
        return to_return
    ...
    def get_episode_path(self,episode_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}".format(episode_name=episode_name,)
        return to_return


    def get_film_path(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film"
        return to_return


    def get_light_export_folder(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/Light_Setups/Light_Export_Groups/"
        return to_return
    ...
    def get_project_shelf_json(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/Maya_Shelves/build_shelf_dict.json"
        return to_return


    def get_publish_report_folder(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/PublishReports"
        return to_return
    ...
    def get_render_preset_config(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/render_preset_config.json"
        return to_return


    def get_render_presets(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/RenderSettings_Presets/"
        return to_return
    ...
    def get_seq_path(self,episode_name=None,seq_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}".format(episode_name=episode_name,seq_name=seq_name,)
        return to_return
    ...
    def get_sequence_preview_folder(self,episode_name=None,seq_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/_Preview".format(episode_name=episode_name,seq_name=seq_name,)
        return to_return
    ...
    def get_sequence_previs_file(self,episode_name=None,seq_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_PREVIS/01_Maya/{episode_name}_{seq_name}_PREVIS.ma".format(episode_name=episode_name,seq_name=seq_name,)
        return to_return
    ...
    def get_shot_2D_passes_folder(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/passes/".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_ae_precomp_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/03_Comp//{episode_name}_{seq_name}_{shot_name}_Precomp.aep".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_anim_folder(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/01_Animation".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_anim_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/01_Animation/{episode_name}_{seq_name}_{shot_name}_Animation.ma".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_anim_preview_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/_Preview/{episode_name}_{seq_name}_{shot_name}.mov".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_animatic_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/{episode_name}_{seq_name}_{shot_name}_Animatic.mp4".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_comp_folder(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/03_Comp/".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_comp_output_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/05_CompOutput/{episode_name}_{seq_name}_{shot_name}_0001.exr".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_comp_output_file_mov(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/05_CompOutput/{episode_name}_{seq_name}_{shot_name}_CompOutput.mov".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_comp_output_folder(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/05_CompOutput".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_comp_preview_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/_Preview/{episode_name}_{seq_name}_{shot_name}_Comp.mov".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_light_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/02_Light/{episode_name}_{seq_name}_{shot_name}_Light.ma".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_passes_folder(self,episode_name=None,seq_name=None,shot_name=None,render_prefix=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/passes/{render_prefix}/{episode_name}_{seq_name}_{shot_name}_{render_prefix}".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,render_prefix=render_prefix,)
        return to_return
    ...
    def get_shot_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return


    def get_shot_publish_path(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/PublishReports/Film"
        return to_return
    ...
    def get_shot_publish_report_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/PublishReports/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}.json".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_render_path(self,episode_name=None,seq_name=None,shot_name=None,render_prefix=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/04_Publish/{episode_name}_{seq_name}_{shot_name}_{render_prefix}_Render.ma".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,render_prefix=render_prefix,)
        return to_return
    ...
    def get_shot_tb_anim_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/{episode_name}_{seq_name}_{shot_name}".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_yeti_cache_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/04_Publish/YetiCache/".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return


    def get_tb_scene_template_file(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/Template/_TBSceneTemplate/BaseFile/BaseFile.xstage"
        return to_return
    ...
    def get_template_asset_path(self,asset_type=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/Template/{asset_type}_Template_Folder/".format(asset_type=asset_type,)
        return to_return


    def get_template_path(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/Template"
        return to_return
    ...
    def get_users_json(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/users.json"
        return to_return
    ...
    def get_Anim(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/{asset_name}_Anim.mb".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_AnimScene(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/04_Publish/{episode_name}_{seq_name}_{shot_name}_AnimRef.mb".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_Blendshape(self,asset_type=None,asset_category=None,asset_name=None,asset_step=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/{asset_name}_{asset_step}_Ref.mb".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,asset_step=asset_step,)
        return to_return
    ...
    def get_GPU(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/{asset_name}_GPU.abc".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_Ingest(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/{asset_name}_Ingest.mb".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_Model(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/{asset_name}_Model_Ref.mb".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_Proxy(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/{asset_name}_Proxy.mb".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_Render(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/{asset_name}_Render.mb".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_Rig(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/{asset_name}_Rig_Ref.mb".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_VrayProxy(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/{asset_name}_VrayProxy.vrmesh".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_YetiAlembicCache(self,asset_type=None,asset_category=None,asset_name=None,yeti_node=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/YetiGroom/{asset_name}_{yeti_node}_AlembicCache.abc".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,yeti_node=yeti_node,)
        return to_return
    ...
    def get_YetiGroom(self,asset_type=None,asset_category=None,asset_name=None,yeti_node=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/YetiGroom/{asset_name}_{yeti_node}_Groom.grm".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,yeti_node=yeti_node,)
        return to_return
    ...
    def get_asset_thumbnail_path(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/04_Design/Thumbnail/{asset_name}_thumbnail.png".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return


    def get_folder_icon_path(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/Resource/icon/folder.png"
        return to_return


    def get_no_thumb_icon_path(self):
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Pipeline/Resource/icon/No_Thumbnail.png"
        return to_return
    ...
    def get_shot_anim_thumbnail_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/Thumbnails/{episode_name}_{seq_name}_{shot_name}_anim_thumbnail.jpg".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_animatic_thumbnail_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/Thumbnails/{episode_name}_{seq_name}_{shot_name}_animatic_thumbnail.jpg".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_comp_thumbnail_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/Thumbnails/{episode_name}_{seq_name}_{shot_name}_comp_thumbnail.jpg".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_render_thumbnail_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "P:/930440_Den_saerlige_mester/Pilot/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/Thumbnails/{episode_name}_{seq_name}_{shot_name}_render_thumbnail.jpg".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
