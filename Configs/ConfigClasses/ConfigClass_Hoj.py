...
class ConfigClass():
    def __init__(self):
        ...
        self.users={'Animation': ['Anna', 'Bernardo', 'Christian', 'Conor', 'Daniel', 'Elias', 'Elliot', 'Fanny', 'Gustavo', 'James', 'Jamie', 'Julia', 'Julie', 'Kristoffer', 'Lho', 'Louise', 'Malene', 'Mads', 'Maya', 'Mik', 'Mikkel', 'Otto', 'Paula', 'Petra', 'Sabrina', 'Teo', 'Tue', 'Ugo', 'Vedel'], 'Render': ['Alexandre', 'James', 'Bernardo', 'Christian', 'Mads']}
