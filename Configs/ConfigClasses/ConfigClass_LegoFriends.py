...
class ConfigClass():
    def __init__(self):
        ...
        self.project_settings={'maya_render': 'arnold', 'fps': '25fps', 'cmEnabled': 1, 'cmViewTransform': 'ACES 1.0 SDR-video (sRGB)', 'tb_width': 1920, 'tb_height': 1080, 'tb_size_multi': 1.1, 'tb_output_format': 'PNG4', 'tb_number_padding': '3'}
