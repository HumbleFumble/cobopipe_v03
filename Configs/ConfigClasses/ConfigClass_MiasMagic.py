...
class ConfigClass():
    def __init__(self):
        ...
        self.asset_work_file="<asset_work_folder>/<asset_name>_<asset_step>"
        ...
        self.users={'Animation': ['Camilla'], 'Render': ['Christian', 'Ursula', 'Kaare', 'Amalie', 'Jacob']}
        
        self.ref_order={'Char': ['Model', 'Rig', 'Shading'], 'Set': ['Base'], 'Setdress': ['Base'], 'Prop': ['Base']}
        
        self.ref_steps={'Prop': {'Base': ['Anim', 'Render']}, 'Char': {'Model': ['Model'], 'Blendshape': ['Blendshape'], 'Rig': ['Anim', 'Rig'], 'Shading': ['Render']}, 'Setdress': {'Base': ['Render']}, 'Set': {'Base': ['Rig']}}
        ...
        import getConfig
        self.old = None
        self.util = getConfig.getJsonConfigUtil("MiasMagic")
    ...
    def get_asset_design_folder(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/_WFH_Projekter/930450_MiasMagicComicBook/Production/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/04_Design".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_publish_report_folder(self):
        to_return = "P:/_WFH_Projekter/930450_MiasMagicComicBook/Production/Pipeline/PublishReports"
        return to_return


    def get_python_path(self):
        to_return = "P:/tools/_Scripts/Production_scripts/_base_production/"
        return to_return
    ...
    def get_Anim(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/_WFH_Projekter/930450_MiasMagicComicBook/Production/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/{asset_name}_Anim.mb".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_Model(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/_WFH_Projekter/930450_MiasMagicComicBook/Production/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/{asset_name}_Model_Ref.mb".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_Render(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/_WFH_Projekter/930450_MiasMagicComicBook/Production/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/{asset_name}_Render.mb".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_Rig(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "P:/_WFH_Projekter/930450_MiasMagicComicBook/Production/Assets/3D_Assets/{asset_type}/{asset_category}/{asset_name}/02_Ref/{asset_name}_Rig_Ref.mb".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
