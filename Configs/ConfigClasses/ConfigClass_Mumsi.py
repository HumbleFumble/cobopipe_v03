...
class ConfigClass():
    def __init__(self):
        self.project_name="Mumsi"
        self.base_path="W:/930505_Mumsi/Production"
        ...
        self.users={'Animation': ['Marco', 'Mikkel', 'Macela'], 'Render': ['Adalstein', 'Christian', 'Bernardo', 'Mads']}
        
        self.ref_order={}
        
        self.ref_steps={}
        
        self.project_settings={'fps': '25fps', 'tb_width': 1920, 'tb_height': 1080, 'tb_size_multi': 1.0, 'tb_output_format': 'TGA4', 'tb_number_padding': '3'}
        
        self.project_style={'animation_style': ['AE', 'Toonboom'], 'comp_style': ['AE'], 'default_animation_style': 'Toonboom', 'default_comp_style': 'AE'}
        
        self.preview_dict={'comp': ['shot_comp_output_file_mov'], 'render': ['shot_tb_render_scene_stack'], 'anim': ['shot_anim_preview_file'], 'animatic': ['shot_animatic_file']}
        
        import getConfig
        self.old = None
        self.util = getConfig.getJsonConfigUtil("Mumsi")
    ...
    def get_ae_precomp_template_file(self):
        to_return = "W:/930505_Mumsi/Production/Pipeline/Template/_AECompTemplate/ae_precomp_template.aep"
        return to_return
    ...
    def get_asset_base_path(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Asset//{asset_type}/{asset_category}/{asset_name}".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_asset_design_folder(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Asset//{asset_type}/{asset_category}/{asset_name}/04_Design".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return


    def get_asset_publish_path(self):
        to_return = "W:/930505_Mumsi/Production/Pipeline/PublishReports/Assets"
        return to_return
    ...
    def get_asset_publish_report_file(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Pipeline/PublishReports/Assets/{asset_type}/{asset_category}/{asset_name}.json".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_asset_ref_folder(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Asset//{asset_type}/{asset_category}/{asset_name}/02_Ref".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return
    ...
    def get_asset_texture_folder(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Asset//{asset_type}/{asset_category}/{asset_name}/03_Texture".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return


    def get_asset_top_path(self):
        to_return = "W:/930505_Mumsi/Production/Asset/"
        return to_return
    ...
    def get_asset_work_file(self,asset_type=None,asset_category=None,asset_name=None,asset_step=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Asset//{asset_type}/{asset_category}/{asset_name}/01_Work/Maya/{asset_name}_{asset_step}.ma".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,asset_step=asset_step,)
        return to_return
    ...
    def get_asset_work_folder(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Asset//{asset_type}/{asset_category}/{asset_name}/01_Work/Maya".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return


    def get_base_path(self):
        to_return = "W:/930505_Mumsi/Production"
        return to_return


    def get_contact_sheet_category_file(self):
        to_return = "W:/930505_Mumsi/Production/Pipeline/contact_sheet_category.json"
        return to_return


    def get_cryptomatte_list(self):
        to_return = "W:/930505_Mumsi/Production/Pipeline/cryptomatteList.json"
        return to_return
    ...
    def get_episode_info_file(self,episode_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_BrowserInfo.json".format(episode_name=episode_name,)
        return to_return
    ...
    def get_episode_path(self,episode_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}".format(episode_name=episode_name,)
        return to_return


    def get_film_path(self):
        to_return = "W:/930505_Mumsi/Production/Film"
        return to_return
    ...
    def get_light_export_folder(self):
        to_return = "W:/930505_Mumsi/Production/Assets/Light_Setups/Light_Export_Groups/"
        return to_return
    ...
    def get_project_shelf_json(self):
        to_return = "W:/930505_Mumsi/Production/Pipeline/Maya_Shelves/build_shelf_dict.json"
        return to_return


    def get_publish_report_folder(self):
        to_return = "W:/930505_Mumsi/Production/Pipeline/PublishReports"
        return to_return
    ...
    def get_render_preset_config(self):
        to_return = "W:/930505_Mumsi/Production/Pipeline/render_preset_config.json"
        return to_return


    def get_render_presets(self):
        to_return = "W:/930505_Mumsi/Production/Pipeline/RenderSettings_Presets/"
        return to_return
    ...
    def get_seq_path(self,episode_name=None,seq_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}".format(episode_name=episode_name,seq_name=seq_name,)
        return to_return
    ...
    def get_sequence_preview_folder(self,episode_name=None,seq_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/_Preview".format(episode_name=episode_name,seq_name=seq_name,)
        return to_return
    ...
    def get_sequence_previs_file(self,episode_name=None,seq_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_PREVIS/01_Maya/{episode_name}_{seq_name}_PREVIS.ma".format(episode_name=episode_name,seq_name=seq_name,)
        return to_return
    ...
    def get_shot_2D_passes_folder(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/Passes".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_ae_precomp_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/Comp/{episode_name}_{seq_name}_{shot_name}_Precomp.aep".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_anim_folder(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_anim_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/{episode_name}_{seq_name}_{shot_name}_Animation.ma".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_anim_preview_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/_Preview/{episode_name}_{seq_name}_{shot_name}.mov".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_animatic_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/{episode_name}_{seq_name}_{shot_name}_Animatic.mov".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_blocking_preview_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/_Preview/Blocking/{episode_name}_{seq_name}_{shot_name}_Blocking.mov".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_comp_folder(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/Comp".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_comp_output_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/_Preview/{episode_name}_{seq_name}_{shot_name}_Comp.mov".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_comp_output_file_mov(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/_CompOutput/{episode_name}_{seq_name}_{shot_name}_CompOutput.mov".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_comp_output_folder(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/_CompOutput".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_crypto_render_file(self,episode_name=None,seq_name=None,shot_name=None,render_prefix=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/04_Publish/{episode_name}_{seq_name}_{shot_name}_{render_prefix}_Crypto_Render.ma".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,render_prefix=render_prefix,)
        return to_return
    ...
    def get_shot_light_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/02_Light/{episode_name}_{seq_name}_{shot_name}_Light.ma".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_passes_folder(self,episode_name=None,seq_name=None,shot_name=None,render_prefix=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/passes/{render_prefix}/{episode_name}_{seq_name}_{shot_name}_{render_prefix}".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,render_prefix=render_prefix,)
        return to_return
    ...
    def get_shot_publish_path(self):
        to_return = "W:/930505_Mumsi/Production/Pipeline/PublishReports/Film"
        return to_return
    ...
    def get_shot_publish_report_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Pipeline/PublishReports/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}.json".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_render_path(self,episode_name=None,seq_name=None,shot_name=None,render_prefix=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/04_Publish/{episode_name}_{seq_name}_{shot_name}_{render_prefix}_Render.ma".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,render_prefix=render_prefix,)
        return to_return
    ...
    def get_shot_sound_file(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/{episode_name}_{seq_name}_{shot_name}_Sound.wav".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_tb_anim_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/{episode_name}_{seq_name}_{shot_name}".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_tb_render_scene_stack(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/Passes/{episode_name}_{seq_name}_{shot_name}_*".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_yeti_cache_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/04_Publish/YetiCache/".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return


    def get_tb_scene_template_file(self):
        to_return = "W:/930505_Mumsi/Production/Pipeline/Template/_TBSceneTemplate/BaseFile/BaseFile.xstage"
        return to_return
    ...
    def get_template_asset_path(self,asset_type=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Pipeline/Template/{asset_type}_Template_Folder/".format(asset_type=asset_type,)
        return to_return


    def get_template_path(self):
        to_return = "W:/930505_Mumsi/Production/Pipeline/Template"
        return to_return
    ...
    def get_asset_thumbnail_path(self,asset_type=None,asset_category=None,asset_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Asset//{asset_type}/{asset_category}/{asset_name}/04_Design/Thumbnail/{asset_name}_thumbnail.png".format(asset_type=asset_type,asset_category=asset_category,asset_name=asset_name,)
        return to_return


    def get_folder_icon_path(self):
        to_return = "W:/930505_Mumsi/Production/Pipeline/Resource/icon/folder.png"
        return to_return


    def get_no_thumb_icon_path(self):
        to_return = "W:/930505_Mumsi/Production/Pipeline/Resource/icon/No_Thumbnail.png"
        return to_return
    ...
    def get_shot_anim_thumbnail_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/Thumbnails/{episode_name}_{seq_name}_{shot_name}_anim_thumbnail.jpg".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_animatic_thumbnail_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/Thumbnails/{episode_name}_{seq_name}_{shot_name}_animatic_thumbnail.jpg".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_comp_thumbnail_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/Thumbnails/{episode_name}_{seq_name}_{shot_name}_comp_thumbnail.jpg".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
    ...
    def get_shot_render_thumbnail_path(self,episode_name=None,seq_name=None,shot_name=None,**kwargs):
        ...
        to_return = "W:/930505_Mumsi/Production/Film/{episode_name}/{episode_name}_{seq_name}/{episode_name}_{seq_name}_{shot_name}/Thumbnails/{episode_name}_{seq_name}_{shot_name}_render_thumbnail.jpg".format(episode_name=episode_name,seq_name=seq_name,shot_name=shot_name,)
        return to_return
