...
class MainWindow(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.asset_path = CC.get_asset_top_path()
            ...
            if(source is self.tree):
                ...
                if not action == None:
                    if action.text() == "Print Name":
                        print(node.getName())
                    if action.text() == "Publish":
                        self.publishNodes(nodes)
