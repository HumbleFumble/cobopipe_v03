/*
	Peg To Static Transformation v1.21
...
function RIG_Peg_To_Static_Transformation()
{
	...
	{	
		...
		var useTiming = node.getAttr(drawing, 1, "drawing.elementMode").boolValue();
	...
	function private_functions()
	{
		...
		{		
			...
			var useTiming = node.getAttr(drawing, 1, "drawing.elementMode").boolValue();
			var drawColumn = node.linkedColumn(drawing, useTiming ? "drawing.element" : "drawing.customName.timing");		
			node.setTextAttr(newSwitch, "drawing.elementMode", 1, useTiming ? "On" : "Off");
