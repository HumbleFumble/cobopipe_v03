...
@echo off
T:/_Executables/python/Python310/python.exe T:/_Pipeline/cobopipe_v02-001/TB/ToonBoom_Global_Python/updateHotbar.py
EXIT /B 0
...
def run(username):
    ...
    sourcePath = os.path.abspath(os.path.join(os.path.dirname(__file__), 'Scripting_Hotbars/Toon Boom Harmony Premium/2100-scripts'))
    print(sourcePath)
