...
def process(scene_path):
    _string = """HarmonyPremium -script "include('T:/_Pipeline/cobopipe-v02-001/TB/ToonBoom_Global_Scripts/CB_UpdatePalettes.js');run('P:/930462_HOJ_Project/Production/Pipeline/palette_update_list.json');" -scene """
